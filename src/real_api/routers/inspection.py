...
async def get_inspection_results(client: "ZCloudRealClient", instance_id: str) -> dict:
...
async def trigger_inspection(client: "ZCloudRealClient", instance_id: str) -> dict:
